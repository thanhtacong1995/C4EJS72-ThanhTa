...
//     console.log(data.hits[i].benefits)
// }

// 4
// let a = 'The process of figuring out why your program has a certain error and how to fix it'
// let b ='When your task is complete, the only thing you have to do is to wait for users to use it (no additional codes or actions needed)'
// let c ='The formal word for ‘error’'
// let d ='The short version of Project Manager, the person in charge of the final result of a project'
// let e ='UI means User Interface, UX mean User Experience, are the process to define how your products looks and feels'
// let ui ='ui/ux'
// let dict = {
//        debug : a,
//        done : b,
...
// if (key != false){
//     prompt('add new word')
//     let newExp = prompt('add new expe')
//     dict.newValue = newExp
//     console.log(dict)
// }
...
// let index1 = prompt('Enter your category')
// for (let i=0; i<phone.length; i++){
//     if (index1 == phone[i].Category){
//         console.log(`#${i+1}`,'Name:',phone[i].Name)
//         console.log('Price:',phone[i].Price)
//     }
// }
...
//         Stat: a
//         },
//         {Prog:'Basics of JavaScript',
//         Stat: a
//         },
//         {Prog:'Node Package Manager (npm)',
//         Stat: a},
//         {Prog:'Git',
//         Stat: a
//         },
...
//     console.log(`${i+1}.`,task[i].Prog)
//     console.log(task[i].Stat)
// }

// let choice = prompt('Enter you command (New, Delete, Update, Complete').toUpperCase()
// if (choice == 'NEW'){
//     let object = {}
...
//     let num = Number(prompt('Enter position')) -1
//     if (Number.isNaN())
//     console.log(' add a number')
//     else if (num>= task.length){
//     console.log('number too big')
//     }
//     else{
//     let pos = prompt('Enter new title')
//     task[num].Prog = pos
//     for (let i=0; i <task.length; i++){
//         console.log(`${i+1}.`,task[i].Prog)
//         console.log(task[i].Stat)
...
//     let index = Number(prompt('Enter position')) -1
//     if (Number.isNaN())
//     console.log(' add a number')
//     else if (index>= task.length){
//     console.log('number too big')
//     }
//     else{
//     task[index].Stat = 'true'
//     for (let i=0; i <task.length; i++){
//         console.log(`${i+1}.`,task[i].Prog)
//         console.log(task[i].Stat)
//     }
...
// }
// else if(luachon == 'D'){
//     let index1 = prompt('Choose position to delete') -1
//     if (Number.isNaN())
//     console.log(' add a number')
//     else if (index1>= task.length){
//     console.log('number too big')
//     }
//     else{quanAo.splice(index1, 1)
//     for (let i=0; i <task.length; i++){
//             console.log(`${i+1}.`,task[i].Prog)
//             console.log(task[i].Stat)
// }
